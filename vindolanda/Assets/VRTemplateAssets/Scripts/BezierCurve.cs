...
#pragma warning restore 649
        ...
        public void DrawCurve()
        {
            ...
            if (startPointPosition == m_LastStartPosition && endPointPosition == m_LastEndPosition)
            ...
            m_ControlPoints[1] =
                startPointPosition + (m_StartPoint.right * (dist * m_CurveFactorStart));
            ...
            if (
                Vector3.Distance(startPointPosition, endPointPosition)
                < (smallestCurveLength * m_LastViewerScale)
            )
            {
                segmentCount = 2;
            }
            ...
            for (var i = 1; i <= segmentCount; i++)
            {
                ...
                var pixel = CalculateCubicBezierPoint(
                    t,
                    m_ControlPoints[0],
                    m_ControlPoints[1],
                    m_ControlPoints[2],
