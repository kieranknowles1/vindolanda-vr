    ...
    static class HandsSampleProjectValidation
    {
        ...
        static readonly List<BuildValidationRule> s_BuildValidationRules =
            new List<BuildValidationRule>
            {
                ...
                {
                    IsRuleEnabled = () =>
                        s_HandsPackageAddRequest == null || s_HandsPackageAddRequest.IsCompleted,
                    Message =
                        $"[{k_SampleDisplayName}] XR Hands ({k_HandsPackageName}) package must be installed or updated to use this sample.",
                    Category = k_Category,
                    CheckPredicate = () =>
                        PackageVersionUtility.GetPackageVersion(k_HandsPackageName)
                        >= s_MinimumPackageVersion,
                    FixIt = () =>
                    {
                        if (
                            s_HandsPackageAddRequest == null
                            || s_HandsPackageAddRequest.IsCompleted
                        )
                ...
                new BuildValidationRule
                {
                    ...
                    CheckPredicate = () =>
                        ProjectValidationUtility.SampleImportMeetsMinimumVersion(
                            ...
                            PackageVersionUtility.GetPackageVersion(k_XRIPackageName)
                        ),
                    FixIt = () =>
                    {
                        if (
